...
function FormEditAnamnese({
  ...
  const {
   ...
   defaultValues: {
      ...
      stress: isStress,
      circulatory: isCirculatory,
      allergy: isAllergy,
      anaemia: isAnaemia,
      legPain: isLegPain,
      backPain: isBackPain,
      physical: isPhysical,
      physicalName: isPhysicalName,
      anotherDisease: isAnotherDisease,
      surgery: isSurgery,
      surgeryName: isSurgeryName,
      medicament: isMedicament,
      medicamentName: isMedicamentName,
  ...
  async function onSubmit(formData) {
    ...
    try{
      await AnamneseServices.updateAnamneseById(id, formData);
      setIsLoading(false);
      toast.success("Dados alterados com sucesso!");
    }
    catch(error){
      setIsLoading(false)
      toast.error("Erro ao alterar ficha!");
    }
  }
...
export default FormEditAnamnese